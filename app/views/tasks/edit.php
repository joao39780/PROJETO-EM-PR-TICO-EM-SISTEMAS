      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
       ...
       <div class="card card-body bg-light mt-5">
        <h2><i class="fas fa-edit"></i> Editar tarefa</h2>
            <p> Edite sua tarefa apartir do formulário abaixo:</p>
            ...
            <div class="form-group mt-2">
                ...
                <option selected value="<?php echo $data['priorty']; ?>">...</option>
            ...
            <input type="submit" class="btn btn-block mt-3" style="width:600px;background-color:#3366ff;color:#fff;" value="Editar Tarefa">
        </form>
        </div>
</main>
</body>